...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Priyanka, an AI Engineer building generative and agentic AI systems that are production-ready — from RAG pipelines to multi-agent orchestration. This portfolio talks back, just like my agents do.",
    src: '/profile-priyanka.jpg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['GenAI', 'Agentic AI', 'RAG', 'AI Engineer'].map(
              (tag) => (
                <span
                  key={tag}
